          ...
          <div className="col-span-2 border rounded p-5 shadow">
            <table className="table-auto w-full">
              ...
              <tbody>
                <td>1</td>
                <td>product name</td>
                <td><img width={'70px'} height={'70px'} src="https://static.vecteezy.com/system/resources/thumbnails/021/495/594/small/3d-shopping-cart-with-a-basket-icon-illustration-png.png" alt="" /></td>
                <td>
                  <div className="flex">
