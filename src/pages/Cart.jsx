      ...
      <div style={{ paddingTop: '100px' }} className='px-5'>
        {
          userCart?.length > 0 ?
              ...
              <div className="grid grid-cols-3 gap-4 mt-5">
                <div className="col-span-2 border rounded p-5 shadow">
                    ...
                    <tbody>
                      {
                        userCart?.map((product, index) =>(
                          <tr>
                            ...
                            <td>
                            <button onClick={()=>dispatch(removeCartItem(product?.id))} className="text-red-600"><i className='fa-solid fa-trash'></i></button></td>
                          </tr>
                        ))
                      }
                  ...
                  <div className="float-right mt-5">
                    ...
                    <Link to={'/'} className="bg-blue-600 rounded ms-3 p-2 text-white">SHOP MORE</Link>
                  </div>
            ...
            : <div className="flex flex-col justify-center items-center h-screen">
              ...
              <div className="text-3xl text-red-600 mt-4">Your cart is empty</div>
            </div>}
      </div>
    </>
  )
